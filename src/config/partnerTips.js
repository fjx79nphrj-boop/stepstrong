export const PARTNER_TIPS = [
  ...
  },
  {
    ...
    tip: "Try: 'When we disagree about rules, can we talk about it privately first? When it happens in front of the kids, it signals that I don't have authority here \u2014 and that makes it harder for them to respect me.'",
  ...
  },
  {
    ...
    tip: "Say: 'I'm not trying to replace anyone. I'm trying to build my own relationship with your child. That takes time, and it will look different from what they have with their other parent \u2014 and that's okay.'",
  ...
  },
  {
    ...
    tip: "Try: 'I need an hour to reset after today. That's not me giving up \u2014 it's me making sure I can show up again tomorrow. Can you handle bedtime tonight?'",
  ...
  },
  {
    ...
    tip: "Respond: 'I hear you, and I know time matters. But right now, I need you to acknowledge that this is hard \u2014 not solve it, just see it. Can you just sit with me in this for a minute?'",
  ...
  },
  {
    ...
    tip: "Wait until you're calm, then: 'When [specific thing] happened today and nothing was said, I felt unsupported. I'm not asking you to punish them \u2014 I'm asking you to say something in the moment, even something small, so they know that's not okay.'",
    why: "Bio-parents often freeze when caught between their child and their partner. They need specific, small requests \u2014 not general demands to 'do something.'",
  },
  {
    title: "The loyalty conflict isn't about you",
    situation: "Your partner's child acts worse after visits with their other parent.",
    tip: "Tell your partner: 'I've noticed the pattern too. It's not about us doing something wrong \u2014 they're processing loyalty conflict. The best thing we can do is keep things calm and predictable when they come back.'",
